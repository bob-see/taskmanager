...
INSERT INTO "new_Task" ("category", "completedAt", "completedOn", "createdAt", "dueAt", "id", "notes", "profileId", "projectId", "startDate", "title", "updatedAt") SELECT "category", "completedAt", "completedAt", "createdAt", "dueAt", "id", "notes", "profileId", "projectId", "startDate", "title", "updatedAt" FROM "Task";
DROP TABLE "Task";
